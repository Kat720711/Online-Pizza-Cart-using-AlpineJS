document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log(favoriteBtnSmall, favoriteBtnMedium, favoriteBtnLarge);

    if (favoriteBtnSmall) {
        favoriteBtnSmall.addEventListener('click', function(e) {
            e.preventDefault();
    ...
    if (favoriteBtnMedium) {
        favoriteBtnMedium.addEventListener('click', function(e) {
            ...
            if (iconMedium.textContent === 'favorite_border') {
                ...
                favoriteBtnMedium.classList.add('favorite-clicked-medium');
            } else {
                iconMedium.textContent = 'favorite_border';
                favoriteBtnMedium.classList.remove('favorite-clicked-medium');
            }
        });
    }
